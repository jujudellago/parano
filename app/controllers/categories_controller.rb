class CategoriesController < ApplicationController
  ...
  def create
    ...
    # @category['synopsis_fr']= language_values['synopsis_fr']
    # @category['synopsis_de']= JujuHelper.nil_if_blank(language_values['synopsis_de'])
    # @category['synopsis_en']= JujuHelper.nil_if_blank(language_values['synopsis_en'])
    @category.save!
    respond_to do |format|
      if @category.save
